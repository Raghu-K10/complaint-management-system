      ...
      <div className="tc-root">
        ...
        <main className="tc-main">
          ...
          <div className="tc-header">
            ...
            <Link to="/submit" className="tc-btn-new">
          ...
          <div className="tc-section">
            <div className="tc-section-header">
              ...
              {!loading && <span className="tc-count-badge">{totalCount} total</span>}
            </div>
            ...
            {loading ? (
              ...
              <div className="tc-state">
                ...
                <p className="tc-state-text">
                  No complaints found.<br />Submit a new complaint to start tracking its status.
                </p>
                <Link to="/submit" className="tc-state-link">File a complaint →</Link>
              </div>
            ) : (
                      ...
                      <div className="tc-item-meta">
                        {complaint.department?.name && (
                          <span className="tc-meta-chip">
                            <IconDept /> {complaint.department.name}
                          </span>
                        )}
                        {complaint.createdAt && (
                          <span className="tc-meta-chip">
